...
const usuarios = [
    { nroDoc : "00000200", idUnidadAcademica : 20, pass : "cursos" , email : "cursos@unl.edu.ar" },
    { nroDoc : "00000410", idUnidadAcademica : 20, pass : "ice123" , email : "extensionenelcurriculo@unl.edu.ar" },
    { nroDoc : "29720316", idUnidadAcademica : 20, pass : "intfcs" , email : "integraciondefunciones@gmail.com" },
    { nroDoc : "00000312", idUnidadAcademica : 20, pass : "prod12" , email : "producciones.unl@gmail.com" },
    { nroDoc : "00000312", idUnidadAcademica : 20, pass : "fcultu" , email : "formacionculturalunl@gmail.com" },
];
...
const usuariosToSQL = ()=>{
    ...
    try {
        let ids = [
            ...
            '60405ed8-81d4-4664-b505-706689f8e084'
        ];
