...
type IRequestActividad = ActividadAttributes & {
  listaRelaciones      ?: Array<RelacionId>,
  listaObjetivos       ?: Array<ObjetivoId>,
  listaProgramasSIPPE  ?: Array<ProgramaSippeId>,
  listaMetas           ?: Array<MetaAttributes>,
  listaUbicaciones     ?: Array<UbicacionAttributes>,
  listaInstituciones   ?: Array<InstitucionAttributes>,
  listaFechasPuntuales ?: Array<FechaPuntualAttributes>,
  listaEnlaces         ?: Array<EnlaceAttributes>
}

type IResponseActividad = IRequestActividad;

type TDataInstanciaActividad = ActividadAttributes & {
        
  listaRelaciones      ?: Map<RelacionId,ESTADO_BD>,
  listaObjetivos       ?: Map<ObjetivoId,ESTADO_BD>,
  listaProgramasSIPPE  ?: Map<ProgramaSippeId,ESTADO_BD>,
  listaMetas           ?: Array<MetaId>,
  listaUbicaciones     ?: Array<UbicacionId>,
  listaInstituciones   ?: Array<InstitucionId>,
  listaFechasPuntuales ?: Array<FechaPuntualAttributes>,
  listaEnlaces         ?: Array<EnlaceAttributes>
} 
type TItemActividad = {
...
export class Actividad extends Model<ActividadAttributes, ActividadCreationAttributes> implements ActividadAttributes {
  ...
  //   };
  //   private cargarFechasPuntuales(desde : Date , hasta : Date , listaFechas ?: Array<FechaPuntualCreationAttributes> )
  //   {
  ...
  //   };
  //   private cargarInstituciones( listaInstituciones ?: Array< InstitucionAttributes> )
  //   {
  ...
  //               .map( institucion => Institucion.build(institucion,this));
  ...
  //   private cargarMetas(listaMetas ?: Array<MetaCreationAttributes> )
  //   {
  ...
  //   };
  //   private cargarUbicaciones( listaUbicaciones ?: Array<UbicacionCreationAttributes>)
  //   {
  ...
  //   };
  //   private cargarEnlaces(listaEnlaces ?: Array<EnlaceCreationAttributes>)
  //   {
  ...
  //   public static async validar ( data : TDataInstanciaActividad, transaction ?: Transaction) : Promise<void> {
