...
export const generarEmailValidaciónRegistro = (_to : string, _idUsuario : string) => ({
  ...
  export const generateRecuperationEmail = (_to : string, token : string) => ({
    ...
    html : `
        ...
        <body>
            <section>
                <p>Recibimos una solicitud de cambio de contraseña para el usuario con este correo electrónico</p>
                <p>Para realizar el cambio de contraseña, haga clic en el siguiente enlace :</p>
                <p><a href="${process.env.SERVER_HOST}/cambiarContraseña/${token}">CAMBIAR MI CONTRASEÑA</a></p> 
            </section>
            <footer>
                <hr>
                <h2>Universidad Nacional del Litoral</h2>
