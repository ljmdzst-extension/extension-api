...
export default class ServiciosInstitucion implements IServiciosInstitucion {
    leerDatosDeBD(iModelo: Model<any, any>, transaction?: Transaction | undefined): Promise<void> {
        throw new Error("Method not implemented.");
    }
    guardarDatosEnBD(iModelo: Model<any, any>, transaction?: Transaction | undefined): Promise<void> {
        throw new Error("Method not implemented.");
    }
    definirPersistencia(iModelo: Model<any, any>, transaction?: Transaction | undefined): Promise<void> {
        throw new Error("Method not implemented.");
    }
    verDatos(iModelo: Model<any, any>) {
        throw new Error("Method not implemented.");
    }
    editarDatos(iModelo: Model<any, any>, data: any): void {
        throw new Error("Method not implemented.");
    }
